...
SGLang Simulator tracks the current `main` branch and the two most recent SGLang releases. The current integration is validated with `v0.5.16`, `v0.5.17`, and `main`.
